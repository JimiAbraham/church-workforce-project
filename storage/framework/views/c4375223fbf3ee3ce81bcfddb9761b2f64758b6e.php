                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                                        <div class="col-4 pt-2">
                                                            <h5 class="font-size-15"><?php echo e($protocols); ?></h5>
                                                            <p class="text-muted mb-0">Protocol</p>
                                                        </div>
                                                        <div class="col-4 pt-2">
                                                            <h5 class="font-size-15"><?php echo e($media); ?></h5>
                                                            <p class="text-muted mb-0">Media</p>
                                                        </div>

                                                        <div class="col-4 pt-2">
                                                            <h5 class="font-size-15"><?php echo e($avalanche); ?></h5>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                               <div class="col-4 pt-2">
                                                                   <h5 class="font-size-15"><?php echo e($ushering); ?></h5>
                                                                   <p class="text-muted mb-0">Ushering</p>
                                                               </div>
                                                               <div class="col-4 pt-2">
                                                                   <h5 class="font-size-15"><?php echo e($pru); ?></h5>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                               <div class="col-4 pt-2">
                                                                   <h5 class="font-size-15"><?php echo e($pcu); ?></h5>
                                                                   <p class="text-muted mb-0">PCU</p>
                                                               </div>
                                                               <div class="col-4 pt-2">
                                                                   <h5 class="font-size-15"><?php echo e($childcare); ?></h5>
                                                                   <p class="text-muted mb-0">ChildCare</p>
                                                               </div>
       
                                                               <div class="col-4 pt-2 ">
                                                                   <h5 class="font-size-15"><?php echo e($qc); ?></h5>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h4 class="mb-0"><?php echo e($single); ?>/<?php echo e($married); ?></h4>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h4 class="mb-0"><?php echo e($workers); ?></h4>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h4 class="mb-0"><?php echo e($HOD); ?></h4>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h4 class="mb-0"><?php echo e($female); ?> / <?php echo e($male); ?></h4>
                                                    </div>
...
</html><?php /**PATH C:\Users\USER\Desktop\New folder\htdocs\cwf3\cwf3\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>